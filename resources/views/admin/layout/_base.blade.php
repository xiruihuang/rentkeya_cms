...
<head>
    <meta charset="UTF-8">
    <title>@section('title') Rentkeya @show{{-- 页面标题 --}}</title>
    <meta name="description" content="{{ isset($description) ? $description : 'Rentkeya' }}" />
    <meta name="keywords" content="Rentkeya,{{ cache('website_keywords') }}" />
    <meta name="author" content=Rentkeya,"{{ cache('system_author_website') }}" />
